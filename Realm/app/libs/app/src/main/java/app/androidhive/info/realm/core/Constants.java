...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "app.androidhive.info.realm";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "Realm";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "app.androidhive.info.realm.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "app.androidhive.info.realm.";
