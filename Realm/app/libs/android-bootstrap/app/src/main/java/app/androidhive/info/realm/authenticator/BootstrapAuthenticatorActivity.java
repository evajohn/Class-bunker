...
import app.androidhive.info.realm.BootstrapApplication;
import app.androidhive.info.realm.R;
import app.androidhive.info.realm.R.id;
import app.androidhive.info.realm.R.layout;
import app.androidhive.info.realm.R.string;
import app.androidhive.info.realm.core.BootstrapService;
import app.androidhive.info.realm.core.Constants;
import app.androidhive.info.realm.core.User;
import app.androidhive.info.realm.events.UnAuthorizedErrorEvent;
import app.androidhive.info.realm.ui.TextWatcherAdapter;
import app.androidhive.info.realm.util.SafeAsyncTask;
import app.androidhive.info.realm.util.Toaster;
