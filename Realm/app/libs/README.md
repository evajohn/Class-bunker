...
* Realm is now API 15+ only.
* I will also be implementing RxJava, Material design and a few other things into this app as well.
There will be *no upgrade path* as Realm is mean to act as a starting point for Android Applications.

# Realm App

[![Build Status](https://travis-ci.org/AndroidBootstrap/app-androidhive-info-realm.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/app-androidhive-info-realm)

This repository contains the source code for the [Realm](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=app.androidhive.info.realm).

Please see the [issues](https://github.app.androidhive.info.realm/app-androidhive-info-realm/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about Realm? Ask away on the [app-androidhive-info-realm discussion forum](https://groups.google.com/forum/#!forum/app-androidhive-info-realm).

<a href="https://play.google.com/store/apps/details?id=app.androidhive.info.realm" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __app.androidhive.info.realm__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____app.androidhive.info.realm__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.app.androidhive.info.realm.R__) will now be renamed
...
signed with a different key.  Manually uninstall Realm from your device and
...
Realm is a result of a template project I've developed over the years as well as
...
Realm is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.app.androidhive.info.realm/app-androidhive-info-realm/contributors) on
...
[pull requests](https://github.app.androidhive.info.realm/app-androidhive-info-realm/pulls).
